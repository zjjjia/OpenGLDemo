...
package com.example.opengldemo.transition.ref;
...
public class TextureMovieEncoder2D implements Runnable {
    ...
    private static class EncoderHandler extends Handler {
        private WeakReference<TextureMovieEncoder2D> mWeakEncoder;

        public EncoderHandler(TextureMovieEncoder2D encoder) {
            mWeakEncoder = new WeakReference<TextureMovieEncoder2D>(encoder);
        }
        ...
        public void handleMessage(Message inputMessage) {
            ...
            TextureMovieEncoder2D encoder = mWeakEncoder.get();
            if (encoder == null) {
